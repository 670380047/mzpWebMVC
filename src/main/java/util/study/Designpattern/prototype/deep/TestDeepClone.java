package util.study.Designpattern.prototype.deep;
...
//        System.out.println(person.getScore().equals(person1.getScore()));
        ...
        //给克隆对象的引用属性list添加一个新的元素：“深拷贝”
        person1.getHobbies().add("深拷贝");
